...
const SuperAdminSubscriptions = () => {
  ...
  // Add animation styles to the document if they don't exist
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 pb-20">
        ...
        <div className="container mx-auto py-3 px-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <div className="bg-gradient-to-r from-indigo-600 to-blue-600 w-8 h-8 md:w-10 md:h-10 rounded-lg flex items-center justify-center shadow-md mr-3">
                <span className="text-white font-bold text-sm md:text-lg">SM</span>
              </div>
              <div className="hidden md:flex items-center text-sm">
                <Button 
                  variant="link" 
                  className="text-slate-500 p-0 h-auto font-medium" 
                  onClick={() => navigate('/super-admin')}
                >
                  Dashboard
                </Button>
                <ChevronRight className="h-4 w-4 mx-1 text-slate-400" />
                <span className="text-indigo-600 font-medium">Subscription Management</span>
              </div>
              ...
              <div className="md:hidden ml-2">
                ...
                {mobileMenuOpen && (
                  <div className="absolute top-14 left-0 w-full bg-white shadow-lg z-50 border-t border-slate-200">
                    <div className="p-3">
                      <Button 
                        variant="ghost" 
                        className="w-full justify-start text-left" 
                        onClick={() => { navigate('/super-admin'); setMobileMenuOpen(false); }}
                      >
                      ...
                      <Button 
                        variant="ghost" 
                        className="w-full justify-start text-left text-indigo-600 bg-indigo-50" 
                      >
          ...
          {/* Page Title Bar */}
          <div className="flex flex-col md:flex-row md:items-center justify-between pt-4 md:pt-6 pb-4">
      ...
      <div className="container mx-auto py-4 md:py-6 space-y-4 md:space-y-6 px-4">
        <Tabs defaultValue="plans" value={activeTab} onValueChange={setActiveTab} className="space-y-4 md:space-y-6">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-30 md:hidden">
        <div className="grid grid-cols-6 h-16">
          <button
            onClick={() => navigate('/super-admin')}
            className="flex flex-col items-center justify-center gap-1 transition-all duration-300 relative text-gray-500 hover:text-indigo-500 hover:bg-gray-50/50 hover:scale-105"
          >
          ...
          <button
            onClick={() => navigate('/super-admin?tab=admins')}
            className="flex flex-col items-center justify-center gap-1 transition-all duration-300 relative text-gray-500 hover:text-indigo-500 hover:bg-gray-50/50 hover:scale-105"
          >
          ...
          <button
            onClick={() => navigate('/super-admin?tab=revenue')}
            className="flex flex-col items-center justify-center gap-1 transition-all duration-300 relative text-gray-500 hover:text-indigo-500 hover:bg-gray-50/50 hover:scale-105"
          >
          ...
          <button
            onClick={() => navigate('/super-admin?tab=analytics')}
            className="flex flex-col items-center justify-center gap-1 transition-all duration-300 relative text-gray-500 hover:text-indigo-500 hover:bg-gray-50/50 hover:scale-105"
          >
            <LineChart className="h-5 w-5 transition-all duration-300" />
            <span className="text-xs font-medium">Analytics</span>
          </button>
          
          <button
            onClick={() => navigate('/super-admin?tab=activity')}
            className="flex flex-col items-center justify-center gap-1 transition-all duration-300 relative text-gray-500 hover:text-indigo-500 hover:bg-gray-50/50 hover:scale-105"
          >
          ...
          <button
            className="flex flex-col items-center justify-center gap-1 transition-all duration-300 relative text-indigo-600 bg-gradient-to-t from-indigo-50 to-transparent scale-105"
          >
            <Settings className="h-5 w-5 transition-all duration-300 animate-bounce-subtle" />
